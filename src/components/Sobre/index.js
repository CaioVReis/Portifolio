    ...
    return (
        <div className="md:w-[100%] md:h-[85%]  hidden md:block " id="Sobre" >
            ...
            <div className="md:mt-[100px] md:flex">
                ...
                <main className=" mt-[40px]  w-[812px] mr-[40px] mb-[40px] h-[398px] ">
                    <p className="  w-[270px] h-[80px]  ml-[20px]  p-2 ">
                        <p className="text-white text-2xl font-serif">Olá muito prazer,</p>
                        <p className="text-white text-2xl font-serif flex gap-4">sou<p className="text-[#00f7ef]">CAIO VINICIUS.</p></p>
                    </p>
                    <p className=" w-[80%] h-[120px] -mt-[10px] ml-[20px] mr-[20px] p-2">
                        <p className="text-white font-sans text-lg antialiased "> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries,</p>
